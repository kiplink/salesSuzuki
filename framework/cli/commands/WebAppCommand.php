...
EOD;
	...
	{
		$fileList['kredit.php']['callback']=array($this,'generateIndex');
	...
	/**
	 * Inserts path to framework's yii.php into application's kredit.php
	 *
	...
	public function generateIndex($source,$params)
	{
		...
		$yii=$this->getRelativePath($yii,$this->_rootPath.DIRECTORY_SEPARATOR.'kredit.php');
		$yii=str_replace('\\','\\\\',$yii);
