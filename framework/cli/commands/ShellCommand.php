 ...
 * entry-script | config-file: optional, the path to
   ...
   the 'kredit.php' file under the current directory.
...
EOD;
	...
	public function run($args)
	{
		if(!isset($args[0]))
			$args[0]='kredit.php';
		$entryScript=isset($args[0]) ? $args[0] : 'kredit.php';
		...
		{
			chdir($cwd);
			$_SERVER['SCRIPT_NAME']='/kredit.php';
			$_SERVER['REQUEST_URI']=$_SERVER['SCRIPT_NAME'];
			$_SERVER['SCRIPT_FILENAME']=$cwd.DIRECTORY_SEPARATOR.'kredit.php';
