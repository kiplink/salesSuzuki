 ...
 * <ul>
 * <li>The first rule says that if the user requests the URL '/path/to/kredit.php/articles',
 *   it should be treated as '/path/to/kredit.php/article/list'; and vice versa applies
 ...
 *   '/path/to/kredit.php/article/13', it should be treated as '/path/to/kredit.php/article/read?id=13';
 ...
 * For example, using the rules above, the URL '/kredit.php/post/123/create'
